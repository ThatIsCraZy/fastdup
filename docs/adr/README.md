...
| Normal startup and background verification | 0091: committed Metadata start; 0090: paced scrub, GC gate and sticky integrity failure; 0023 retains full disaster rebuild. |
