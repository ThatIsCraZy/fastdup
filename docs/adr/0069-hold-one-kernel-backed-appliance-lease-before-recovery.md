...
Under ADR 0046 the diagnostic record is one Direct-I/O 4-KiB block, with UTF-8
text followed by zero padding. Rewriting it keeps physical EOF aligned; it is
not a repository storage envelope and does not change the kernel lock's
ownership authority.
