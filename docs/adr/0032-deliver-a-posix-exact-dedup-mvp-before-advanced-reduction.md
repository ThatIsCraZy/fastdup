...
boundary. Online Similarity, depth-one Prefix/Sparse-XOR, automatic GC,
DATA-tier Recovery Checkpoints, and Small-File placement are implemented
(ADRs 0020, 0084, 0088, and 0089). ADR 0054 supersedes user-DATA FastCDC.
The Samba Fast Clone adapter and contract tests exist; real Veeam qualification
remains open under ADR 0043. Implementation does not imply device-loss or
