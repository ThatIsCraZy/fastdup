...
stage_root="$package_root/fastdup-0.7.4"
...
tar -C "$package_root" -czf \
    "$rpmbuild_root/SOURCES/fastdup-0.7.4-x86_64.tar.gz" \
    fastdup-0.7.4
...
find "$rpmbuild_root/RPMS" -type f -name 'fastdup-0.7.4-*.x86_64.rpm' -print
